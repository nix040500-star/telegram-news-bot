...
def main():
    ...
    print("📰 RSS에서 찾은 기사 수:", len(feed.entries))
...
아래 제공되는 단 하나의 뉴스 기사를 바탕으로,
투자자들이 핵심 내용을 한눈에 파악할 수 있도록
3~4개의 단락으로 나누어 차분하고 신뢰감 있는
뉴스 분석 스타일로 작성해줘.

[작성 규칙]

1. 객관적인 금융 뉴스 스타일로 작성할 것.
2. 시장에 미치는 의미를 자연스럽게 설명할 것.
3. 번호 매기기나 기계적인 개조식은 사용하지 말 것.
4. 자연스러운 줄글 형태로 단락을 구분할 것.
5. 마지막 줄에는 반드시 아래 형식으로 링크를 넣을 것.
